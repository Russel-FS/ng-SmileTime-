          ...
          <form (ngSubmit)="onSubmit()" #form="ngForm">
            <div class="form-section">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" [(ngModel)]="patient.lastName" name="lastName" required>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group">
                  <label>Teléfono</label>
                  <input type="tel" [(ngModel)]="patient.phone" name="phone" required>
                </div>
                <div class="form-group">
                  <label>Email</label>
            ...
            <div class="form-section">
              ...
              <div class="form-group">
                ...
                <textarea [(ngModel)]="patient.allergies" name="allergies" rows="2"></textarea>
              </div>
              <div class="form-group">
                <label>Notas Médicas</label>
                <textarea [(ngModel)]="patient.medicalNotes" name="medicalNotes" rows="2"></textarea>
              </div>
            </div>
...
export class AddPatientModalComponent {
    ...
    onSubmit() {
        this.save.emit(new DentalManagement({
            ...this.patient,
            id: '',
            status: 'active'
        } as DentalManagement));
